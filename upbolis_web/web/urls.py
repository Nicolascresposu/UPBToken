...
urlpatterns = [
    ...
    path('admin-panel/users/topup/', views.admin_topup_tokens, name='admin_topup_tokens'),
    path('admin-panel/users/<int:user_id>/manage/', views.admin_manage_user, name='admin_manage_user'),
